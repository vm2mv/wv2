...
namespace wvWare
{
    ...
    private:
        ...
        void processSpecialCharacter(wvWare::UChar character, U32 globalCP, SharedPtr<const Word97::CHP> chp );
        void processFootnote(wvWare::UChar character, U32 globalCP, SharedPtr<const Word97::CHP> chp );
